...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/TwilioLookup'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Fabio Borella' => 'info@pencildrummer.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/TwilioLookup.git', :tag => s.version.to_s }
  ...
  # s.resource_bundles = {
  #   'TwilioLookup' => ['TwilioLookup/Assets/*.png']
  # }
